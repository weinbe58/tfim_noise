...
for t in ${T[*]}; do
    ...
    # python tfim_spin_bath_MF.py $N $((4*N)) $t $gamma $omega 2 runfiles/1d_model_spin_bath_2/ &
    # python tfim_spin_bath_MF.py $N $N $t $gamma $omega 1 runfiles/1d_model_spin_bath_1/ &
    pids+=($!)
done
# wait for all pids
for pid in ${pids[*]}; do
